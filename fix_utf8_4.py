...
replacements = [
    (r'Truy.n h.nh', 'Truyền hình'),
    (r'T.t c.', 'Tất cả'),
    (r'Y.u th.ch', 'Yêu thích'),
    (r'Kh.ng t.m th.y k.nh', 'Không tìm thấy kênh'),
    (r'B. l.c n.ng cao', 'Bộ lọc nâng cao'),
    ...
    (r'Da xo. K.nh n.i b.t', 'Đã xoá Kênh nổi bật'),
    (r'Ph.ng to t.i da', 'Phóng to tối đa'),
    (r'N.n h.ng m. d.u m.t', 'Nền hồng mờ dịu mắt'),
    (r'N.n x.m m. trong su.t', 'Nền xám mờ trong suốt'),
    (r'Vi.n h.ng gradient', 'Viền hồng gradient'),
    (r'Vi.n tr.ng m.', 'Viền trắng mờ'),
    (r'L.p c.c quang .nh s.ng \(tu. ch.n th.m d. gi.ng .nh 1\)', 'Lớp cực quang ánh sáng (tuỳ chọn thêm để giống ảnh 1)')
]
...
print('Replaced exact strings with dot wildcard')
