content = """package com.tvlaoto.data.parser
        ...
        reader.useLines { lines ->
            for (rawLine in lines) {
                ...
                if (line.startsWith("#EXTINF:", ignoreCase = true)) {
                    ...
                    val (progTitle, progTime, progDesc) = ChannelLogoProvider.getProgramMock(currentChannelName)
...
with open('app/src/main/java/com/tvlaoto/data/parser/M3uParser.kt', 'w', encoding='utf-8') as f:
    f.write(content)
print("Rewrote M3uParser.kt completely")
